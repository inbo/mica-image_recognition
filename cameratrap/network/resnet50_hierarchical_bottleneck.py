...
from .functions_network import (load_train_val_test,
                                       compute_weights,
                                       split_mammals,
...
train_labels = to_categorical(np.array(train['label']),num_classes=classes)
validation_labels = to_categorical(np.array(validation['label']), num_classes=classes)
