...
from tensorflow.keras.preprocessing.image import (img_to_array, random_shift, random_rotation,
                                                    random_shear, random_zoom) #Additional data augmentation option. Add to DataGenerator.
from tensorflow.keras.applications.resnet50 import preprocess_input

from ..preprocessing.hoebeke import black_border
...
class DataGenerator(object):
    ...
    def __init__(self, df, dim_x, dim_y, dim_z, batch_size,
                 shuffle=True, mode='train', augmentation=False):
        self.df = df
        self.dim_x = dim_x
        self.dim_y = dim_y
        self.dim_z = dim_z
